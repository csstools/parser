...
PostCSS Parser (7.0.32):         6240 values in 15 ms
PostCSS Parser (Development):   58823 values in 34 ms (2.2 times slower)
PostCSS/Selector/Value Parsers: 28491 values in 85 ms (5.5 times slower)
```
